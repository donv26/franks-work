!(function (t, e) {
  ...
  function i(t) {
    ...
    return [
      s(t)[0],
      (1 / 255) * Math.min(e, Math.min(i, o)) * 100,
  ...
  function a(t) {
    var e,
      ...
      n = t[2] / 255;
    return [
      100 * ((1 - i - (e = Math.min(1 - i, 1 - o, 1 - n))) / (1 - e) || 0),
      100 * ((1 - o - e) / (1 - e) || 0),
      100 * ((1 - n - e) / (1 - e) || 0),
      100 * e,
    ];
    ...
    return [
      100 *
        (0.4124 *
          ...
          0.1805 *
            (o = 0.04045 < o ? Math.pow((o + 0.055) / 1.055, 2.4) : o / 12.92)),
  ...
  function d(t) {
    ...
    return (
      ...
      [
        116 * (o = 0.008856 < o ? Math.pow(o, 1 / 3) : 7.787 * o + 16 / 116) -
          16,
        500 * (i - o),
        200 *
          (o - (n = 0.008856 < n ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116)),
      ]
    );
  }
  function h(t) {
    ...
    (e = 2 * l - (i = l < 0.5 ? l * (1 + r) : l + r - l * r)), (n = [0, 0, 0]);
    for (var c = 0; c < 3; c++)
      (o = a + (1 / 3) * -(c - 1)) < 0 && o++,
        1 < o && o--,
        (s =
  ...
  function m(t) {
    var e,
      ...
      a = t[2] / 100;
    return (
      (i = -0.9689 * n + 1.8758 * s + 0.0415 * a),
      (o = 0.0557 * n + -0.204 * s + 1.057 * a),
      (e =
        0.0031308 < (e = 3.2406 * n + -1.5372 * s + -0.4986 * a)
  ...
  function v(t) {
    ...
    return (
      ...
      [
        ...
        500 * (e - i),
        200 *
          (i - (o = 0.008856 < o ? Math.pow(o, 1 / 3) : 7.787 * o + 16 / 116)),
      ]
    );
  }
  function y(t) {
    ...
    return (
      ...
      [
        (e =
          e / 95.047 <= 0.008856
            ? (e = (95.047 * (a / 500 + n - 16 / 116)) / 7.787)
            : 95.047 * Math.pow(a / 500 + n, 3)),
        i,
        (o =
          o / 108.883 <= 0.008859
            ? (o = (108.883 * (n - r / 200 - 16 / 116)) / 7.787)
            : 108.883 * Math.pow(n - r / 200, 3)),
      ]
    );
  }
  function x(t) {
    var e,
      ...
      n = t[2];
    return (
      (e = (360 * Math.atan2(n, o)) / 2 / Math.PI) < 0 && (e += 360),
  ...
  function w(t) {
    var e,
      ...
      o = t[1];
    return (
      (e = (t[2] / 360) * 2 * Math.PI), [i, o * Math.cos(e), o * Math.sin(e)]
    );
  }
  function k(t) {
    return S[t];
  ...
  function O(t) {
    if (t) {
      ...
      if (o) {
        ...
        for (n = o[2], o = o[1], s = 0; s < e.length; s++)
  ...
  (V.prototype = {
    ...
    luminosity: function () {
      for (var t = this.values.rgb, e = [], i = 0; i < t.length; i++) {
        var o = t[i] / 255;
        e[i] = o <= 0.03928 ? o / 12.92 : Math.pow((0.055 + o) / 1.055, 2.4);
      }
    ...
    mix: function (t, e) {
      ...
      return this.rgb(
        a * this.red() + r * i.red(),
        a * this.green() + r * i.green(),
        a * this.blue() + r * i.blue()
      ).alpha(this.alpha() * o + i.alpha() * (1 - o));
    },
    toJSON: function () {
      return this.rgb();
    },
    ...
    (V.prototype.setChannel = function (t, e, i) {
      ...
      return void 0 === i
        ? o[e]
        : (i === o[e] || ((o[e] = i), this.setValues(t, o)), this);
    }),
    ...
    X = {
      ...
      each: function (t, e, i, o) {
        ...
        if (X.isArray(t))
          ...
          else for (n = 0; n < s; n++) e.call(i, t[n], n);
        else if (X.isObject(t))
          for (s = (a = Object.keys(t)).length, n = 0; n < s; n++)
            e.call(i, t[a[n]], a[n]);
      },
      arrayEquals: function (t, e) {
        ...
        for (i = 0, o = t.length; i < o; ++i)
          if (
            ((n = t[i]), (s = e[i]), n instanceof Array && s instanceof Array)
          ) {
      ...
      _mergerIf: function (t, e, i) {
        var o = e[t],
          n = i[t];
        X.isObject(o) && X.isObject(n)
          ? X.mergeIf(o, n)
          : e.hasOwnProperty(t) || (e[t] = X.clone(n));
      },
      merge: function (t, e, i) {
        ...
        for (o = (i = i || {}).merger || X._merger, n = 0; n < c; ++n)
          if (((e = l[n]), X.isObject(e)))
            for (r = 0, a = (s = Object.keys(e)).length; r < a; ++r)
              o(s[r], t, e, i);
        return t;
      },
    ...
    nt = {
          ...
          t.moveTo(e, l),
            r < c && l < d
              ...
              ? (t.moveTo(r, i),
                ...
                t.arc(r, l, a, et, K + et))
              : l < d
              ? (t.arc(r, l, a, -K, 0), t.arc(r, d, a, 0, K))
              : t.arc(r, l, a, -K, K),
            t.closePath(),
            t.moveTo(e, i);
        } else t.rect(e, i, o, n);
      ...
      lineTo: function (t, e, i, o) {
        ...
        if (n) {
          ...
          i.tension
            ? t.bezierCurveTo(
                o ? e.controlPointPreviousX : e.controlPointNextX,
                o ? e.controlPointPreviousY : e.controlPointNextY,
                o ? i.controlPointNextX : i.controlPointPreviousX,
                o ? i.controlPointNextY : i.controlPointPreviousY,
                i.x,
                i.y
              )
            : t.lineTo(i.x, i.y);
  ...
  var rt = at,
    ...
    ct = {
        ...
        return (
          Q.isObject(t)
            ? ((e = +t.top || 0),
              ...
              (n = +t.left || 0))
            : (e = i = o = n = +t || 0),
          { top: e, right: i, bottom: o, left: n, height: e + o, width: n + i }
        );
      },
      _parseFont: function (t) {
        ...
        return (
          (n.string =
            !(e = n) || Q.isNullOrUndef(e.size) || Q.isNullOrUndef(e.family)
              ? null
              : (e.style ? e.style + " " : "") +
                (e.weight ? e.weight + " " : "") +
                e.size +
  ...
  var bt = {
      ...
      requestAnimationFrame: function () {
        var t = this;
        null === t.request &&
          (t.request = dt.requestAnimFrame.call(window, function () {
      ...
      advance: function () {
        for (var t, e, i, o, n = this.animations, s = 0; s < n.length; )
          (e = (t = n[s]).chart),
            ...
            t.currentStep >= i
              ? (dt.callback(t.onAnimationComplete, [t], e),
                (e.animating = !1),
                n.splice(s, 1))
              : ++s;
      },
  ...
  dt.extend(wt.prototype, {
                ...
                Object.defineProperty(n, t, {
                  ...
                  value: function () {
                    var e = Array.prototype.slice.call(arguments),
                      t = o.apply(this, e);
                    return (
                      dt.each(n._chartjs.listeners, function (t) {
    ...
    transition: function (t) {
      for (
        var e = this.getMeta(), i = e.data || [], o = i.length, n = 0;
        n < o;
        ++n
      )
        i[n].transition(t);
    ...
    setHoverStyle: function (t) {
      ...
      (t.$previousStyle = {
        ...
        (n.borderColor = yt(
          [o.hoverBorderColor, e.hoverBorderColor, s(n.borderColor)],
          void 0,
          i
        )),
        (n.borderWidth = yt(
          [o.hoverBorderWidth, e.hoverBorderWidth, n.borderWidth],
          void 0,
          i
        ));
    },
  ...
  var St = gt.extend({
      ...
      inRange: function (t, e) {
        ...
        if (i) {
          for (
            var o = dt.getAngleFromPoint(i, { x: t, y: e }),
              n = o.angle,
              s = o.distance,
              a = i.startAngle,
              r = i.endAngle;
          ...
          i.borderWidth &&
            ("inner" === i.borderAlign
              ? (e.beginPath(),
                ...
                i.innerRadius > s
                  ? ((t = s / i.innerRadius),
                    e.arc(i.x, i.y, i.innerRadius - s, n + t, o - t, !0))
                  : e.arc(i.x, i.y, s, n + Math.PI / 2, o - Math.PI / 2),
                e.closePath(),
                e.clip(),
                e.beginPath(),
  ...
  var Mt = gt.extend({
      draw: function () {
        var t,
          ...
          d = -1;
        for (
          this._loop && r.length && r.push(r[0]),
            s.save(),
          ...
          (e = r[t]),
            ...
            (o = e._view),
            0 === t
              ? o.skip || (s.moveTo(o.x, o.y), (d = t))
              : ((i = -1 === d ? i : r[d]),
                o.skip ||
                  ((d !== t - 1 && !a) || -1 === d
                    ? s.moveTo(o.x, o.y)
                    : dt.canvas.lineTo(s, i._view, e._view),
                  (d = t)));
        s.stroke(), s.restore();
      },
    }),
  ...
  var At = gt.extend({
      ...
      draw: function (t) {
        var e = this._view,
          ...
          c = l.defaultColor;
        e.skip ||
          (void 0 !== t && !dt.canvas._isPointInArea(e, t)) ||
  ...
  function zt(t, e, i) {
    ...
    return (
      s &&
      (o || (e >= s.left && e <= s.right)) &&
      (n || (i >= s.top && i <= s.bottom))
    );
  }
  rt._set("global", {
    elements: {
      ...
      draw: function () {
        var t,
          ...
          b =
            ...
            l &&
              (e.horizontal
                ? e.base > e.x && (l = Ot(l, "left", "right"))
                : e.base < e.y && (l = Ot(l, "bottom", "top")),
              (c[l] = !0)),
            (h = c),
            dt.isObject(d)
              ? ((n = +d.top || 0),
            ...
            {
              outer: { x: u.left, y: u.top, w: p, h: f },
              inner: {
                x: u.left + g.l,
                y: u.top + g.t,
                w: p - g.l - g.r,
  ...
  var qt = kt.extend({
      ...
      update: function (t) {
        var e,
          i,
          o = this.getMeta().data;
        for (this._ruler = this.getRuler(), e = 0, i = o.length; e < i; ++e)
      ...
      _getStacks: function (t) {
        var e,
          ...
          a = [];
        for (e = 0; e < s; ++e)
          (i = o.getDatasetMeta(e)).bar &&
            o.isDatasetVisible(e) &&
            (!1 === n ||
              (!0 === n && -1 === a.indexOf(i.stack)) ||
              (void 0 === n &&
                (void 0 === i.stack || -1 === a.indexOf(i.stack)))) &&
            a.push(i.stack);
        return a;
      },
      ...
      getRuler: function () {
        ...
        return {
          min: dt.isNullOrUndef(i.options.barThickness)
            ? (function (t, e) {
                var i,
                  o,
                  n,
      ...
      calculateBarValuePixels: function (t, e) {
        ...
        if (g || (void 0 === g && void 0 !== m))
          for (i = 0; i < t; ++i)
            (o = l.getDatasetMeta(i)).bar &&
              o.stack === m &&
              o.controller._getValueScaleId() === d.id &&
              l.isDatasetVisible(i) &&
              ((n = +d.getRightValue(u[i].data[e])),
              ((p < 0 && n < 0) || (0 <= p && 0 < n)) && (v += n));
        return (
          (s = d.getPixelForValue(v)),
          (r = (a = d.getPixelForValue(v + p)) - s),
          void 0 !== f &&
            Math.abs(r) < f &&
            ((r = f), (a = (0 <= p && !h) || (p < 0 && h) ? s - f : s + f)),
          { size: r, base: s, head: a, center: a + r / 2 }
        );
      },
          ...
          x =
            "flex" === y.barThickness
              ...
              : ((o = e),
                ...
                (c = n.stackCount),
                (d = n.pixels[o]),
                (r = dt.isNullOrUndef(l)
                  ? ((a = n.min * s.categoryPercentage), s.barPercentage)
                  : ((a = l * c), 1)),
                { chunk: a / c, ratio: r, start: d - a / 2 }),
          _ = this.getStackIndex(t, this.getMeta().stack),
          w = x.start + x.chunk * _ + x.chunk / 2,
          k = Math.min(
            dt.valueOrDefault(y.maxBarThickness, 1 / 0),
            x.chunk * x.ratio
          );
        return { base: w - k / 2, head: w + k / 2, center: w, size: k };
      },
      draw: function () {
        var t = this.chart,
      ...
      _resolveElementOptions: function (t, e) {
        var i,
          ...
          c = {},
          d = { chart: s, dataIndex: e, dataset: a, datasetIndex: this.index },
          h = [
            "backgroundColor",
            "borderColor",
            "borderSkipped",
  ...
  var Ut = kt.extend({
      ...
      updateElement: function (t, e, i) {
        var o = this,
          ...
          h = i
            ...
            : a.getPixelForValue("object" == typeof c ? c : NaN, e, d),
      ...
      _resolveElementOptions: function (t, e) {
        var i,
          ...
          c = a.data[e],
          d = {},
          h = { chart: s, dataIndex: e, dataset: a, datasetIndex: this.index },
          u = [
            "backgroundColor",
            "borderColor",
            "borderWidth",
        ...
        return (
          (d.radius = Yt(
            [r.radius, c ? c.r : void 0, a.radius, l.radius],
            h,
            e
          )),
          d
    ...
    legend: {
          ...
          return l.labels.length && l.datasets.length
            ? l.labels.map(function (t, e) {
                ...
                return {
                  text: t,
                  fillStyle: Xt(
                    [s.backgroundColor, o.backgroundColor, a.backgroundColor],
                    void 0,
                    e
                  ),
                  strokeStyle: Xt(
                    [s.borderColor, o.borderColor, a.borderColor],
                    void 0,
                    e
                  ),
                  lineWidth: Xt(
                    [s.borderWidth, o.borderWidth, a.borderWidth],
                    void 0,
                    e
                  ),
      ...
      onClick: function (t, e) {
        var i,
          ...
          s = e.index,
          a = this.chart;
        for (i = 0, o = (a.data.datasets || []).length; i < o; ++i)
          (n = a.getDatasetMeta(i)).data[s] &&
            (n.data[s].hidden = !n.data[s].hidden);
        a.update();
      },
    },
    cutoutPercentage: 50,
  ...
  var Zt = kt.extend({
    ...
    update: function (t) {
      ...
      if (f < 2 * Math.PI) {
        var m = a.rotation % (2 * Math.PI),
          v =
            (m += 2 * Math.PI * (m >= Math.PI ? -1 : m < -Math.PI ? 1 : 0)) + f,
          b = Math.cos(m),
          y = Math.sin(m),
          x = Math.cos(v),
          _ = Math.sin(v),
      ...
      for (
        n.borderWidth = o.getMaxBorderWidth(),
          ...
          o.outerRadius =
            n.outerRadius - n.radiusLength * o._getRingWeightOffset(o.index),
    ...
    updateElement: function (t, e, i) {
      var o = this,
        ...
        u = o.getDataset(),
        p =
          (i && r.animateRotate) || t.hidden
            ? 0
            : o.calculateCircumference(u.data[e]) *
      ...
      (i && r.animateRotate) ||
        ((v.startAngle =
          0 === e ? a.rotation : o.getMeta().data[e - 1]._model.endAngle),
    ...
    getMaxBorderWidth: function (t) {
      ...
      for (e = 0, i = t.length; e < i; ++e)
        (n = t[e]),
          "inner" !==
            (a = s ? s._resolveElementOptions(n, e) : n._options).borderAlign &&
            ((r = a.borderWidth),
  ...
  var ie = kt.extend({
      ...
      update: function (t) {
        ...
        for (
          c && 0 !== s._model.tension && o.updateBezierControlPoints(),
            e = 0,
            i = a.length;
          e < i;
          ++e
      ...
      _resolveLineOptions: function (t) {
        ...
        return (
          (c.spanGaps = Kt(s.spanGaps, r.spanGaps)),
      ...
      calculatePointY: function (t, e, i) {
        ...
        if (l.options.stacked) {
          for (o = 0; o < i; o++)
            if (
              ((n = a.data.datasets[o]),
              "line" === (s = a.getDatasetMeta(o)).type &&
                s.yAxisID === l.id &&
      ...
      updateBezierControlPoints: function () {
        ...
        if (
          ...
          for (t = 0, e = l.length; t < e; ++t)
            (i = l[t]._model),
              (o = dt.splineCurve(
                dt.previousItem(l, t)._model,
                i,
                dt.nextItem(l, t)._model,
                a.tension
              )),
          ...
          return r.labels.length && r.datasets.length
            ? r.labels.map(function (t, e) {
                ...
                return {
                  text: t,
                  fillStyle: oe(
                    [n.backgroundColor, o.backgroundColor, s.backgroundColor],
                    void 0,
                    e
                  ),
                  strokeStyle: oe(
                    [n.borderColor, o.borderColor, s.borderColor],
                    void 0,
                    e
                  ),
                  lineWidth: oe(
                    [n.borderWidth, o.borderWidth, s.borderWidth],
                    void 0,
                    e
                  ),
                  hidden: isNaN(o.data[e]) || i.data[e].hidden,
  ...
  var ne = kt.extend({
    ...
    update: function (t) {
      ...
      for (
        ...
        (l[e] = r), (o = n._computeAngle(e)), (r += c[e] = o);
      for (e = 0, i = d.length; e < i; ++e)
    ...
    _updateRadius: function () {
      ...
      (e.outerRadius = Math.max(n / 2, 0)),
        (e.innerRadius = Math.max(
          o.cutoutPercentage ? (e.outerRadius / 100) * o.cutoutPercentage : 1,
          0
        )),
        (e.radiusLength =
  ...
  rt._set("pie", dt.clone(rt.doughnut)),
    rt._set("pie", { cutoutPercentage: 0 });
  var se = Zt,
  ...
  var le = kt.extend({
    ...
    update: function (t) {
      ...
      for (
        ...
        o.updateElement(a[e], e, t);
      for (o.updateBezierControlPoints(), e = 0, i = a.length; e < i; ++e)
        a[e].pivot();
    },
    updateElement: function (t, e, i) {
      var o = this,
    ...
    updateBezierControlPoints: function () {
      ...
      for (t = 0, e = a.length; t < e; ++t)
        (i = a[t]._model),
          (o = dt.splineCurve(
            dt.previousItem(a, t, !0)._model,
            i,
            dt.nextItem(a, t, !0)._model,
            i.tension
          )),
  ...
  function ge(o, t, e) {
    ...
    var n = fe(e.axis),
      ...
      a = [];
    return s.length
      ? (o.data.datasets.forEach(function (t, e) {
  ...
  var xe,
    _e = {
      ...
      configure: function (t, e, i) {
        for (
          var o, n = ["fullWidth", "position", "weight"], s = n.length, a = 0;
          a < s;
          ++a
        )
          (o = n[a]), i.hasOwnProperty(o) && (e[o] = i[o]);
      },
      update: function (e, i, t) {
        if (e) {
          ...
          var f,
            ...
            _ = b,
            w = y,
            k = { top: r, left: s, bottom: l, right: a },
            S = [];
          dt.each(v, function (t) {
            var e,
              i = t.isHorizontal();
            i
              ? ((e = t.update(t.fullWidth ? b : _, y / 2)), (w -= e.height))
              : ((e = t.update(x, w)), (_ -= e.width)),
              S.push({ horizontal: i, width: e.width, box: t });
          }),
            (A = v),
            (O = D = F = L = 0),
            ...
            (f = { top: L, left: F, bottom: D, right: O }),
            dt.each(g, z),
            ye(g, k),
            dt.each(m, z),
            ye(m, k),
            ...
            ye(v, (k = { top: r, left: s, bottom: l, right: a }));
  ...
  var Re = {
      ...
      notify: function (t, e, i) {
        ...
        for (o = 0; o < c; ++o)
          if (
            "function" == typeof (r = (s = (n = l[o]).plugin)[e]) &&
            ((a = [t].concat(i || [])).push(n.options), !1 === r.apply(s, a))
          )
            return !1;
        return !0;
      },
          ...
          this._plugins.concat(i.plugins || []).forEach(function (t) {
            if (-1 === o.indexOf(t)) {
              var e = t.id,
                i = s[e];
              !1 !== i &&
                (!0 === i && (i = dt.clone(rt.global.plugins[e])),
                o.push(t),
                n.push({ plugin: t, options: i || {} }));
            }
          }),
          (e.descriptors = n),
          (e.id = this._cacheId),
    ...
    We = {
      ...
      getScaleDefaults: function (t) {
        return this.defaults.hasOwnProperty(t)
          ? dt.merge({}, [rt.scale, this.defaults[t]])
          : {};
      },
      updateScaleDefaults: function (t, e) {
        this.defaults.hasOwnProperty(t) &&
          (this.defaults[t] = dt.extend(this.defaults[t], e));
      },
  ...
  function Be(t, e) {
    return (
      e && (dt.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t
    );
  }
  function Ne(t) {
  ...
  var Ue = gt.extend({
      ...
      update: function (t) {
        var e,
          ...
          $ = S._active,
          P = S._data,
          I = { xAlign: T.xAlign, yAlign: T.yAlign },
          A = { x: T.x, y: T.y },
          L = { width: T.width, height: T.height },
          F = { x: T.caretX, y: T.caretY };
        if ($.length) {
          M.opacity = 1;
          var D = [],
            O = [];
          ...
          C.filter &&
            ...
            (p = I = (function (t, e) {
              ...
              r.y < e.height
                ? (h = "top")
                : r.y > l.height - e.height && (h = "bottom");
              ...
              (o =
                ...
                i(r.x)
                  ? ((d = "left"), n(r.x) && ((d = "center"), (h = a(r.y))))
                  : o(r.x) &&
                    ((d = "right"), s(r.x) && ((d = "center"), (h = a(r.y))));
              var f = t._options;
              return {
            ...
            "right" === x
              ? (g -= u.width)
              : "center" === x &&
                ((g -= u.width / 2) + u.width > f.width &&
                  (g = f.width - u.width),
                g < 0 && (g = 0)),
            "top" === _
              ? (m += w)
              : (m -= "bottom" === _ ? u.height + w : u.height / 2),
            "center" === _
              ? "left" === x
                ? (g += w)
                : "right" === x && (g -= w)
      ...
      getCaretPosition: function (t, e, i) {
        ...
        if ("center" === u)
          (r = f + m / 2),
            (l =
              "left" === h
                ? ((n = (o = p) - c), (s = o), (a = r + c), r - c)
                : ((n = (o = p + g) + c), (s = o), (a = r - c), r + c));
        else if (
          ((s =
            ((o =
              "left" === h
        ...
        return { x1: o, x2: n, x3: s, y1: a, y2: r, y3: l };
      },
          ...
          dt.each(r, function (t, e) {
            (s = o.labelTextColors[e]),
              ...
              dt.each(t.lines, function (t) {
                l &&
                  ((n.fillStyle = o.legendColorBackground),
      ...
      handleEvent: function (t) {
        ...
        return (
          ...
          "mouseout" === t.type
            ? (i._active = [])
            : (i._active = i._chart.getElementsAtEventForMode(t, o.mode, o)),
          (e = !dt.arrayEquals(i._active, i._lastActive)) &&
      ...
      merger: function (t, e, i, o) {
        if ("xAxes" === t || "yAxes" === t) {
          var n,
            ...
            a,
            r = i[t].length;
          for (e[t] || (e[t] = []), n = 0; n < r; ++n)
            (a = i[t][n]),
              (s = Ze(a.type, "xAxes" === t ? "category" : "linear")),
              n >= e[t].length && e[t].push({}),
              !e[t][n].type || (a.type && a.type !== e[t][n].type)
                ? dt.merge(e[t][n], [We.getScaleDefaults(s), a])
                : dt.merge(e[t][n], a);
    ...
    return dt.merge({}, [].slice.call(arguments), {
      merger: function (t, e, i, o) {
        ...
        "scales" === t
          ? (e[t] = Ge(n, s))
          : "scale" === t
          ? (e[t] = dt.merge(n, [We.getScaleDefaults(s.type), s]))
          : dt._merger(t, e, i, o);
      },
    });
  }
  ...
  dt.extend(ti.prototype, {
      ...
      t.scales &&
        ...
        dt.each(e, function (t) {
          ...
          if (i in r && r[i].type === o)
            ((n = r[i]).options = e), (n.ctx = a.ctx), (n.chart = a);
          else {
            var s = We.getScaleConstructor(o);
            if (!s) return;
            (n = new s({ id: i, type: o, options: e, ctx: a.ctx, chart: a })),
              (r[n.id] = n);
          }
    ...
    drawDataset: function (t, e) {
      ...
      !1 !== Re.notify(this, "beforeDatasetDraw", [o]) &&
        (i.controller.draw(e), Re.notify(this, "afterDatasetDraw", [o]));
    },
    ...
    handleEvent: function (t) {
      ...
      return (
        ...
        "mouseout" === t.type
          ? (i.active = [])
          : (i.active = i.getElementsAtEventForMode(t, n.mode, n)),
        dt.callback(o.onHover || o.hover.onHover, [t.native, i.active], i),
        ("mouseup" !== t.type && "click" !== t.type) ||
          (o.onClick && o.onClick.call(i, t.native, i.active)),
  ...
  var di = gt.extend({
      ...
      update: function (t, e, i) {
        ...
        for (
          c.beforeUpdate(),
            c.maxWidth = t,
            c.maxHeight = e,
            c.margins = dt.extend({ left: 0, right: 0, top: 0, bottom: 0 }, i),
            c._maxLabelLines = 0,
          ...
          (a = s[o]),
            (l = r[o]) ? (l.label = a) : r.push((l = { label: a, major: !1 }));
        return (
          (c._ticks = r),
      ...
      afterBuildTicks: function (t) {
        var e = this;
        return dt.isArray(t) && t.length
          ? dt.callback(e.options.afterBuildTicks, [e, t])
          : ((e.ticks =
              dt.callback(e.options.afterBuildTicks, [e, e.ticks]) || e.ticks),
            t);
      },
      ...
      calculateTickRotation: function () {
        ...
        if (o.length && t.options.display && t.isHorizontal())
          for (
            var a,
              r = dt.longestText(e, n.string, o, t.longestTextCache),
              l = r,
      ...
      _autoSkip: function (t) {
        var e,
          ...
          d = n
            ...
            : o.height - (o.paddingTop + o.PaddingBottom),
          h = [];
        for (
          d < c && (r = 1 + Math.floor(c / d)),
      ...
      _isVisible: function () {
        ...
        for (t = 0, e = o.data.datasets.length; t < e; ++t)
          if (
            ...
            ((i = o.getDatasetMeta(t)).xAxisID === this.id ||
              i.yAxisID === this.id)
          )
            return !0;
        return !1;
      ...
      draw: function (M) {
        ...
        if ($._isVisible()) {
          ...
          if (
            ((A =
              "top" === D
                ? ((t = V(L, $.bottom, q)), (I = $.bottom - j), t - q / 2)
                : "bottom" === D
                ? ((t = V(L, $.top, q)), (I = t + q / 2), $.top + j)
                : "left" === D
                ? ((t = V(L, $.right, q)), (I = $.right - j), t - q / 2)
                : ((t = V(L, $.left, q)), (I = t + q / 2), $.left + j)),
            dt.each(s, function (t, e) {
              if (!dt.isNullOrUndef(t.label)) {
                var i,
                  ...
                  b = t.label;
                s =
                  e === $.zeroLineIndex && P.offset === F.offsetGridLines
                    ? ((i = F.zeroLineWidth),
                      (o = F.zeroLineColor),
                      (n = F.zeroLineBorderDash || []),
                      F.zeroLineBorderDashOffset || 0)
                    : ((i = ri(F.lineWidth, e)),
                      (o = ri(F.color, e)),
                      (n = F.borderDash || []),
                ...
                var y = dt.isArray(b) ? b.length : 1,
                  x =
                    ...
                    C &&
                      (1 === k.getTicks().length
                        ? (T -= k.isHorizontal()
                            ? Math.max(T - k.left, k.right - T)
                            : Math.max(T - k.top, k.bottom - T))
                        : (T -=
                            0 === S
                              ? (k.getPixelForTick(1) - T) / 2
                              : (T - k.getPixelForTick(S - 1)) / 2)),
                    T);
                if (E) {
                  var _ = j + W;
            ...
            if (E)
              (g = $.left + ($.right - $.left) / 2),
                (m =
                  "bottom" === D ? $.bottom - b - f.bottom : $.top + b + f.top);
            else {
              var y = "left" === D;
    ...
    hi = di.extend({
      ...
      getLabelForIndex: function (t, e) {
        var i = this,
          o = i.chart;
        return o.getDatasetMeta(e).controller._getValueScaleId() === i.id
          ? i.getRightValue(o.data.datasets[e].data[t])
      ...
      getPixelForValue: function (t, e) {
        ...
        if (
          (null != t && (i = o.isHorizontal() ? t.x : t.y),
      ...
      getTickLimit: function () {
        ...
        return (
          i
            ...
            : ((t = this._computeTickLimit()), (o = o || 11)),
          o && (t = Math.min(o, t)),
          t
        );
      },
      ...
      buildTicks: function () {
        var g = this,
          ...
          i = (g.ticks = (function () {
            ...
            (o = Math.ceil(u / p) - Math.floor(h / p)) > r &&
              (p = dt.niceNum((o * p) / r / a) * a),
              s || pi(d)
                ? (t = Math.pow(10, dt._decimalPlaces(p)))
                : ((t = Math.pow(10, d)), (p = Math.ceil(p * t) / t)),
              (e = Math.floor(h / p) * p),
              (i = Math.ceil(u / p) * p),
              s &&
                (!pi(l) && dt.almostWhole(l / p, p / 1e3) && (e = l),
                !pi(c) && dt.almostWhole(c / p, p / 1e3) && (i = c)),
              (o = (i - e) / p),
              (o = dt.almostEquals(o, Math.round(o), p / 1e3)
                ? Math.round(o)
                : Math.ceil(o)),
              (e = Math.round(e * t) / t),
              (i = Math.round(i * t) / t),
    ...
    mi = fi.extend({
        ...
        if (
          ...
          dt.each(t, function (t, e) {
            var o = l.getDatasetMeta(e),
              i = [
                o.type,
                void 0 === r.stacked && void 0 === o.stack ? e : "",
                o.stack,
              ].join(".");
            void 0 === d[i] &&
      ...
      _computeTickLimit: function () {
        ...
        return this.isHorizontal()
          ...
          : ((t = dt.options._parseFont(this.options.ticks)),
      ...
      getPixelForValue: function (t) {
        ...
        return e.isHorizontal()
          ? e.left + (e.width / n) * (o - i)
          : e.bottom - (e.height / n) * (o - i);
      },
      getValueForPixel: function (t) {
        var e = this,
          i = e.isHorizontal(),
  ...
  var _i = di.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = xi(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min
              ? ((t.min = Math.pow(10, Math.floor(dt.log10(t.min)) - 1)),
                (t.max = Math.pow(10, Math.floor(dt.log10(t.max)) + 1)))
              : ((t.min = 1), (t.max = 10))),
          null === t.min &&
            (t.min = Math.pow(10, Math.floor(dt.log10(t.max)) - 1)),
          null === t.max &&
            (t.max =
              0 !== t.min ? Math.pow(10, Math.floor(dt.log10(t.min)) + 1) : 10),
          null === t.minNotZero &&
            (0 < t.min
              ? (t.minNotZero = t.min)
              : t.max < 1
              ? (t.minNotZero = Math.pow(10, Math.floor(dt.log10(t.max))))
              : (t.minNotZero = 1));
      },
      buildTicks: function () {
        var t = this,
          ...
          n = (t.ticks = (function (t, e) {
            ...
            0 === s
              ? ((i = Math.floor(dt.log10(e.minNotZero))),
                (o = Math.floor(e.minNotZero / Math.pow(10, i))),
                n.push(s),
                (s = o * Math.pow(10, i)))
              : ((i = Math.floor(dt.log10(s))),
      ...
      getPixelForValue: function (t) {
        ...
        return (
          ...
          (s = l
            ...
            : ((o = a.start), (n = a.end), 1)),
          (i = a.isHorizontal()
            ? ((e = a.width), l ? a.right : a.left)
            : ((e = a.height), (s *= -1), l ? a.top : a.bottom)),
          t !== o &&
            (0 === o &&
              ((e -= h = bi(r.fontSize, rt.global.defaultFontSize)), (o = d)),
      ...
      getValueForPixel: function (t) {
        ...
        if (
          ((o = r ? ((i = s.end), s.start) : ((i = s.start), s.end)),
          (n = s.isHorizontal()
            ? ((e = s.width), r ? s.right - t : t - s.left)
            : ((e = s.height), r ? t - s.top : s.bottom - t)) !== i)
        ) {
          if (0 === i) {
  ...
  function $i(t) {
    ...
    return e.display && t.display
      ? ki(e.fontSize, rt.global.defaultFontSize) + 2 * e.backdropPaddingY
      : 0;
  }
        ...
        t.display && t.pointLabels.display
          ? (function (t) {
              var e,
                i,
                o,
                n = dt.options._parseFont(t.options.pointLabels),
              ...
              for (e = 0; e < d; e++) {
                (o = t.getPointPosition(e, t.drawingArea + 5)),
                  ...
                  (c = t.pointLabels[e] || ""),
                  (i = dt.isArray(c)
                    ? { w: dt.longestText(r, r.font, c), h: c.length * l }
                ...
                p.start < s.l && ((s.l = p.start), (a.l = h)),
                  p.end > s.r && ((s.r = p.end), (a.r = h)),
                  f.start < s.t && ((s.t = f.start), (a.t = h)),
                  f.end > s.b && ((s.b = f.end), (a.b = h));
              }
          ...
          (t.angleLines.display || t.pointLabels.display) &&
            (function (t) {
              ...
              e.save(),
                ...
                (e.strokeStyle = r),
                e.setLineDash &&
                  (e.setLineDash(Ci([o.borderDash, n.borderDash, []])),
                  (e.lineDashOffset = Ci([
                    o.borderDashOffset,
                    n.borderDashOffset,
                    0,
                ...
                if (
                    ...
                    (function (t, e, i, o) {
                      ...
                      if ((a || r) && l && c) {
                        if (
                          ...
                          for (var d = 1; d < r; d++)
                            (n = t.getPointPosition(d, i)), s.lineTo(n.x, n.y);
                        }
                  ...
                  if (
                    ...
                    (l.fillStyle = r.backdropColor),
                      l.fillRect(
                        -n / 2 - r.backdropPaddingX,
                        -i - d.size / 2 - r.backdropPaddingY,
                        n + 2 * r.backdropPaddingX,
                        d.size + 2 * r.backdropPaddingY
                      );
                  }
                  (l.textAlign = "center"),
  ...
  function Hi(t) {
    var e,
      ...
      s = [];
    for (e = 0, i = t.length; e < i; ++e)
      n[(o = t[e])] || ((n[o] = !0), s.push(o));
    return s;
  }
  function ji(t, e, i, o) {
    var n = (function (t, e, i) {
        for (var o, n, s, a = 0, r = t.length - 1; 0 <= a && a <= r; ) {
          if (((n = t[(o = (a + r) >> 1) - 1] || null), (s = t[o]), !n))
            return { lo: null, hi: s };
          if (s[e] < i) a = 1 + o;
          else {
  ...
  function Bi(t, e) {
    ...
    return (
      ...
      null !== a
        ...
        : (n ||
            "function" != typeof s ||
            ((a = s(e)), dt.isFinite(a) || (a = i.parse(a))),
          a)
    );
  }
  function Ni(t, e) {
  ...
  var Vi = di.extend({
    ...
    determineDataLimits: function () {
      ...
      for (t = 0, i = (r.data.datasets || []).length; t < i; ++t)
        if (r.isDatasetVisible(t))
          if (((n = r.data.datasets[t].data), dt.isObject(n[0])))
            for (f[t] = [], e = 0, o = n.length; e < o; ++e)
              (s = Ni(a, n[e])), p.push(s), (f[t][e] = s);
          else {
      ...
      g.length &&
        ...
        (a._table = []),
        (a._timestamps = { data: p, datasets: f, labels: g });
    },
    buildTicks: function () {
      var t,
        e,
            ...
            for (
              r =
                ...
                (function (t) {
                  ...
                  for (
                    e = 0, i = r.length;
                    e < i && ((o = r[e]), !(Math.ceil(n / (a * o)) <= t));
                    ++e
                  );
                  return o;
                })(e),
                h &&
                  ((f = +o.startOf(f, "isoWeek", h)),
      ...
      for (
        "ticks" === p.bounds && g.length && ((h = g[0]), (u = g[g.length - 1])),
          h = Ni(d, f.min) || h,
          u = Ni(d, f.max) || u,
          t = 0,
          e = g.length;
      ...
      return (
        ...
        (d._table = (function (t, e, i) {
          ...
          for (c.push(i), o = 0, n = c.length; o < n; ++o)
            (r = c[o + 1]),
              (s = c[o - 1]),
              (a = c[o]),
              (void 0 !== s && void 0 !== r && Math.round((r + s) / 2) === a) ||
                l.push({ time: a, pos: o / (n - 1) });
          return l;
        ...
        (d._offsets =
          ...
          (s = p).offset &&
            ...
            (s.time.min ||
              ((a = ji(o, "time", n[0], "pos")),
              (l =
                1 === n.length ? 1 - a : (ji(o, "time", n[1], "pos") - a) / 2)),
            s.time.max ||
              ((r = ji(o, "time", n[n.length - 1], "pos")),
              (c =
                1 === n.length
                  ? r
                  : (r - ji(o, "time", n[n.length - 2], "pos")) / 2))),
          { start: l, end: c })),
    ...
    getLabelForIndex: function (t, e) {
      ...
      return (
        dt.isObject(r) && (a = i.getRightValue(r)),
        s.tooltipFormat
          ? o.format(Bi(i, a), s.tooltipFormat)
          : "string" == typeof a
          ? a
          : o.format(Bi(i, a), s.displayFormats.datetime)
      );
    },
    ...
    getPixelForValue: function (t, e, i) {
      var o = null;
      if (
        (void 0 !== e && void 0 !== i && (o = this._timestamps.datasets[i][e]),
        null === o && (o = Ni(this, t)),
        null !== o)
      )
    ...
    getValueForPixel: function (t) {
      var e = this,
        ...
        n =
          (i ? (t - o) / i : 0) * (e._offsets.start + 1 + e._offsets.start) -
          e._offsets.end,
  ...
  ni._date.override(
    ...
    rt._set("global", { plugins: { filler: { propagate: !0 } } });
  var Xi = {
    dataset: function (t) {
      var e = t.fill,
        i = t.chart,
  ...
  function Qi(t, e, i) {
    var o,
      n = t._model || {},
      s = n.fill;
    if ((void 0 === s && (s = !!n.backgroundColor), !1 === s || null === s))
      return !1;
    if (!0 === s) return "origin";
    if (((o = parseFloat(s, 10)), isFinite(o) && Math.floor(o) === o))
      return (
        ("-" !== s[0] && "+" !== s[0]) || (o = e + o),
        !(o === e || o < 0 || i <= o) && o
      );
  ...
  function Zi(t) {
    ...
    if (
      ("start" === n
        ? (s = void 0 === i.scaleBottom ? o.bottom : i.scaleBottom)
        : "end" === n
        ? (s = void 0 === i.scaleTop ? o.top : i.scaleTop)
        : void 0 !== i.scaleZero
        ? (s = i.scaleZero)
        : o.getBasePosition
        ? (s = o.getBasePosition())
        : o.getBasePixel && (s = o.getBasePixel()),
      null != s)
    ) {
      if (void 0 !== s.x && void 0 !== s.y) return s;
      if (dt.isFinite(s))
        return { x: (e = o.isHorizontal()) ? s : null, y: e ? null : s };
    }
    return null;
  }
  function Gi(t, e, i) {
  ...
  function Ji(t, e, i, o, n) {
    var s;
    if (o && n) {
      for (t.moveTo(e[0].x, e[0].y), s = 1; s < o; ++s)
        dt.canvas.lineTo(t, e[s - 1], e[s]);
      for (t.lineTo(i[n - 1].x, i[n - 1].y), s = n - 1; 0 < s; --s)
  ...
  var to = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (o = 0; o < c; ++o)
          (s = null),
            (n = (i = t.getDatasetMeta(o)).dataset) &&
              n._model &&
              n instanceof Rt.Line &&
              (s = {
      ...
      beforeDatasetDraw: function (t, e) {
        ...
        if (i) {
          ...
          r &&
            l &&
            a.length &&
            (dt.canvas.clipArea(o, t.chartArea),
            (function (t, e, i, o, n, s) {
              var a,
                ...
                v = 0,
                b = 0;
              for (t.beginPath(), a = 0, r = p + !!s; a < r; ++a)
                (d = i((c = e[(l = a % p)]._view), l, o)),
                  (h = Ki(c)),
                  (u = Ki(d)),
                  h && u
                    ? ((v = g.push(c)), (b = m.push(d)))
                    : v &&
                      b &&
                      (f
                        ? (h && g.push(c), u && m.push(d))
                        : (Ji(t, g, m, v, b), (v = b = 0), (g = []), (m = [])));
    ...
    legend: {
      ...
      labels: {
        ...
        generateLabels: function (i) {
          var t = i.data;
          return dt.isArray(t.datasets)
            ? t.datasets.map(function (t, e) {
                return {
                  text: t.label,
                  fillStyle: dt.isArray(t.backgroundColor)
                    ? t.backgroundColor[0]
                    : t.backgroundColor,
  ...
  var no = gt.extend({
        ...
        if (((n.font = s.string), c)) {
          ...
          (n.textAlign = "left"),
            ...
            dt.each(t.legendItems, function (t, e) {
              ...
              (0 === e || d[d.length - 1] + i + o.padding > l.width) &&
                ((h += a + o.padding),
                (d[d.length - (0 < e ? 0 : 1)] = o.padding)),
                (r[e] = { left: 0, top: 0, width: i, height: a }),
        ...
        dt.each(h.legendItems, function (t, e) {
          ...
          k
            ? 0 < e &&
              ...
              ((d = b.y += S),
              b.line++,
              (c = b.x = h.left + (m - v[b.line]) / 2 + p.padding))
            : 0 < e &&
              d + S > h.top + h.minSize.height &&
              ((c = b.x = c + h.columnWidths[b.line] + p.padding),
            ...
            (function (t, e, i) {
              if (!(isNaN(_) || _ <= 0)) {
                ...
                if (
                  ...
                  0 !== o && y.strokeRect(t, e, _, x), y.fillRect(t, e, _, x);
                y.restore();
              }
            })(c, d, t),
            (w[e].left = c),
    ...
    handleEvent: function (t) {
      ...
      (e = i._getLegendItemAt(t.x, t.y)),
        "click" === n
          ? e && o.onClick && o.onClick.call(i, t.native, e)
          : (o.onLeave &&
              e !== i._hoveredItem &&
              (i._hoveredItem && o.onLeave.call(i, t.native, i._hoveredItem),
              (i._hoveredItem = e)),
            o.onHover && e && o.onHover.call(i, t.native, e));
    },
  });
  function so(t, e) {
    var i = new no({ ctx: t.ctx, options: e, chart: t });
  ...
  var ao = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.legend,
          i = t.legend;
        e
          ? (dt.mergeIf(e, rt.global.legend),
            i ? (_e.configure(t, i, e), (i.options = e)) : so(t, e))
          : i && (_e.removeBox(t, i), delete t.legend);
      },
  ...
  var lo = gt.extend({
    ...
    fit: function () {
      ...
      t.isHorizontal()
        ? ((o.width = t.maxWidth), (o.height = a))
        : ((o.width = a), (o.height = t.maxHeight)),
        (t.width = o.width),
        (t.height = o.height);
    },
    afterFit: ro,
    ...
    draw: function () {
      ...
      if (i.display) {
        var o,
          ...
          u = t.bottom,
          p = t.right;
        (e.fillStyle = dt.valueOrDefault(
          i.fontColor,
          rt.global.defaultFontColor
        )),
          (e.font = a.string),
          t.isHorizontal()
            ? ((n = h + (p - h) / 2), (s = d + l), (o = p - h))
            : ((n = "left" === i.position ? h + l : p - l),
              (s = d + (u - d) / 2),
              (o = u - d),
  ...
  function co(t, e) {
    var i = new lo({ ctx: t.ctx, options: e, chart: t });
    ...
    fo = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.title,
          i = t.titleBlock;
        e
          ? (dt.mergeIf(e, rt.global.title),
            i ? (_e.configure(t, i, e), (i.options = e)) : co(t, e))
          : i && (_e.removeBox(t, i), delete t.titleBlock);
      },
    };
  ...
  (dt.findIndex = Array.prototype.findIndex
    ? function (t, e, i) {
  ...
  (dt.splineCurve = function (t, e, i, o) {
    var n = t.skip ? e : t,
      ...
      u = o * (d = isNaN(d) ? 0 : d);
    return {
      previous: { x: s.x - h * (a.x - n.x), y: s.y - h * (a.y - n.y) },
      next: { x: s.x + u * (a.x - n.x), y: s.y + u * (a.y - n.y) },
    };
  }),
  ...
  (dt.splineCurveMonotone = function (t) {
    ...
    for (e = 0; e < h - 1; ++e)
      (o = d[e]),
        ...
        o.model.skip ||
          n.model.skip ||
          (dt.almostEquals(o.deltaK, 0, this.EPSILON)
            ? (o.mK = n.mK = 0)
            : ((s = o.mK / o.deltaK),
              (a = n.mK / o.deltaK),
              (l = Math.pow(s, 2) + Math.pow(a, 2)) <= 9 ||
                ((r = 3 / Math.sqrt(l)),
                (o.mK = s * r * o.deltaK),
                (n.mK = a * r * o.deltaK))));
    for (e = 0; e < h; ++e)
  ...
  (dt.getRelativePosition = function (t, e) {
    ...
    return {
      x: (i = Math.round(
        (((i - a.left - l) / u) * s.width) / e.currentDevicePixelRatio
      )),
      y: (o = Math.round(
        (((o - a.top - c) / p) * s.height) / e.currentDevicePixelRatio
      )),
    };
  }),
  ...
  (dt._calculatePadding = function (t, e, i) {
    return -1 < (e = dt.getStyle(t, e)).indexOf("%")
      ? (i * parseInt(e, 10)) / 100
      : parseInt(e, 10);
  }),
  ...
  (dt.getMaximumWidth = function (t) {
    ...
    var i = e.clientWidth,
      o =
        i -
        dt._calculatePadding(e, "padding-left", i) -
        dt._calculatePadding(e, "padding-right", i),
  ...
  (dt.getMaximumHeight = function (t) {
    ...
    var i = e.clientHeight,
      o =
        i -
        dt._calculatePadding(e, "padding-top", i) -
        dt._calculatePadding(e, "padding-bottom", i),
  ...
  (dt.retinaScale = function (t, e) {
    ...
    if (1 !== i) {
      ...
      (o.height = n * i),
        ...
        o.style.height ||
          o.style.width ||
          ((o.style.height = n + "px"), (o.style.width = s + "px"));
    }
  }),
  ...
  (dt.longestText = function (e, t, i, o) {
    ...
    o.font !== t &&
      ((n = o.data = {}), (s = o.garbageCollect = []), (o.font = t)),
      (e.font = t);
    var a = 0;
    dt.each(i, function (t) {
      null != t && !0 !== dt.isArray(t)
        ? (a = dt.measureText(e, n, s, a, t))
        : dt.isArray(t) &&
          dt.each(t, function (t) {
  ...
  (dt.measureText = function (t, e, i, o, n) {
    var s = e[n];
    return (
      s || ((s = e[n] = t.measureText(n).width), i.push(n)), o < s && (o = s), o
    );
  }),
  ...
  (dt.color = U
    ? function (t) {
        return (
          t instanceof CanvasGradient && (t = rt.global.defaultColor), U(t)
        );
      }
    : function (t) {
  ...
  (dt.getHoverColor = function (t) {
    return t instanceof CanvasPattern || t instanceof CanvasGradient
      ? t
      : dt.color(t).saturate(0.5).darken(0.1).rgbString();
  }),
  (ei._adapters = ni),
  (ei.Animation = vt),
  ...
  function mo(t, e, i) {
    ...
    return (
      "string" == typeof t
        ? ((o = parseInt(t, 10)),
          -1 !== t.indexOf("%") && (o = (o / 100) * e.parentNode[i]))
        : (o = t),
      o
    );
  }
  ...
  (function (d, a, g, m) {
      ...
      (t && t.isDefaultPrevented()) ||
        ...
        (o =
          ...
          ? (s = (n = (n = e.selector
              ...
              : g('[data-fancybox="' + o + '"]')).index(i)) < 0 && (s = 0)
          : (n = [i]),
    ...
    if (((d.console = d.console || { info: function (t) {} }), g)) {
      ...
      var t = {
        ...
        o = function (t, e, i) {
          var o = this;
          (o.opts = l({ index: i }, g.fancybox.defaults)),
            ...
            o.addContent(t),
            o.group.length &&
              ((o.$lastFocus = g(a.activeElement).trigger("blur")), o.init());
        };
      g.extend(o.prototype, {
        init: function () {
          ...
          g.fancybox.getInstance() ||
            ...
            !g.fancybox.isMobile &&
              a.body.scrollHeight > d.innerHeight &&
              (s === m &&
                ((t = g(
          ...
          if (!(c.isDragging || c.isClosing || (c.isAnimating && c.firstRun))) {
            ...
            if (
              ...
              if (
                ...
                return (
                  n.opts.animationEffect &&
                    o &&
                    c.$refs.container.css("transition-duration", o + "ms"),
              ...
              g.each(c.slides, function (t, e) {
                ...
                s.pos !== n.pos &&
                  ((l =
                    "fancybox-slide--" + (s.pos > n.pos ? "next" : "previous")),
                  s.$slide.removeClass(
        ...
        scaleToActual: function (t, e, i) {
          ...
          !l.isAnimating &&
            ...
            (s = 0.5 * u - 0.5 * f),
            h < p &&
              (0 < (n = o.left * a - (t * a - t)) && (n = 0),
              n < h - p && (n = h - p)),
            u < f &&
              (0 < (s = o.top * r - (e * r - e)) && (s = 0),
              s < u - f && (s = u - f)),
            l.updateCursor(p, f),
            g.fancybox.animate(
              d,
              { top: s, left: n, scaleX: a, scaleY: r },
              i || 330,
              function () {
                l.isAnimating = !1;
              }
        ...
        getFitPos: function (t) {
          ...
          return (
            ...
            (l = Math.floor(o * l)),
            "image" === t.type
              ? ((c.top = Math.floor(0.5 * (i - l)) + n.top),
                (c.left = Math.floor(0.5 * (e - r)) + n.left))
              : "video" === t.contentType &&
                (r /
                  (s =
        ...
        updateCursor: function (t, e) {
          var i,
            o = this,
            n = o.current,
            s = o.$refs.container.removeClass(
        ...
        isScaledDown: function (t, e) {
          ...
          return (
            t !== m && e !== m
              ...
              : n &&
                (i =
                  (i = g.fancybox.getTranslate(n)).width < o.width &&
                  i.height < o.height),
            i
          );
        },
        ...
        setIframe: function (n) {
          ...
          (n.$content = g(
            ...
            (n.$iframe = s = g(a.tpl.replace(/\{rnd\}/g, new Date().getTime()))
              .attr(a.attr)
              .appendTo(n.$content)),
            a.preload
              ? (e.showLoading(n),
        ...
        getThumbPos: function (t) {
          ...
          return (
            n &&
              (function (t) {
                for (
                  var e = t[0], o = e.getBoundingClientRect(), i = [];
              ...
              (i = {
                ...
                left:
                  n.left - e.left + parseFloat(o.css("border-left-width") || 0),
                width: o.width(),
                height: o.height(),
                scaleX: 1,
                scaleY: 1,
          ...
          return (
            ...
            !1 === i
              ...
              : void ("afterClose" !== t && n.$refs
                  ? n.$refs.container.trigger(t + ".fb", o)
                  : r.trigger(t + ".fb", o))
          );
        },
        updateControls: function (t) {
          ...
          i.$slide.trigger("refresh"),
            ...
            s
              ...
              .toggleClass("disabled", !i.opts.loop && o <= 0),
            s
              .find("[data-fancybox-next]")
              .toggleClass("disabled", !i.opts.loop && o >= e.group.length - 1),
            "image" === i.type
              ? s
      ...
      (i = p.extend(!0, {}, o, n.opts.media)),
        p.each(i, function (t, e) {
          if ((a = h.match(e.matcher))) {
            if (
              ((u = e.type), (d = t), (c = {}), e.paramPlace && a[e.paramPlace])
            ) {
            ...
            return (
              (r = p.extend(!0, {}, e.params, n.opts[t], c)),
              (h =
                "function" === p.type(e.url)
                  ? e.url.call(this, a, r, n)
                  : f(e.url, a, r)),
              (s =
                "function" === p.type(e.thumb)
                  ? e.thumb.call(this, a, r, n)
                  : f(e.thumb, a)),
              "youtube" === t
  ...
  (function (g, r, m) {
    ...
    function c(t) {
      for (
        ...
        (s =
          ("scroll" === o || "auto" === o) && i.scrollHeight > i.clientHeight),
    ...
    (i.prototype.destroy = function () {
              ...
              m.fancybox.stop(e.$slide),
                ...
                e.pos === o.instance.current.pos &&
                  (o.sliderStartPos.left =
                    ...
                    m.fancybox.getTranslate(o.instance.$refs.stage).left);
            }),
      ...
      (i.prototype.limitMovement = function () {
        ...
        return (
          ...
          0 < l && t < n && (n = t - 1 + Math.pow(-t + h + l, 0.8) || 0),
          l < 0 && n < i && (n = i + 1 - Math.pow(i - h - l, 0.8) || 0),
      ...
      (i.prototype.onTap = function (i) {
        function t(t) {
          var e = a.opts[t];
          if ((m.isFunction(e) && (e = e.apply(s, [a, i])), e))
            switch (e) {
              case "close":
        ...
        if (
          ...
          (n.is("img") || !(l > n[0].clientWidth + n.offset().left))
        ) {
          if (
            n.is(
            ...
            if (
              !s.current.$content ||
              !s.current.$content.find(n).addBack().filter(n).length
            )
              return;
            e = "Content";
          }
    ...
    s.extend(o.prototype, {
      ...
      s(t).on({
        "onInit.fb": function (t, e) {
          ...
          !e ||
            e.Thumbs ||
            ((i = new o(e)).isActive && !0 === i.opts.autoStart && i.show());
        },
        "beforeShow.fb": function (t, e, i, o) {
          var n = e && e.Thumbs;
      ...
      s(t).on("click", "[data-fancybox-share]", function () {
        ...
        n &&
          ("function" === s.type(n.opts.share.url) &&
            (t = n.opts.share.url.apply(n, [o, n])),
          (e = n.opts.share.tpl
            .replace(
              /\{\{media\}\}/g,
                  ...
                  a.location.hash !== "#" + e.currentHash &&
                    ...
                    (e.hashTimer = setTimeout(function () {
                      "replaceState" in a.history
                        ? (a.history[o ? "pushState" : "replaceState"](
                            {},
                            s.title,
                            a.location.pathname +
                              a.location.search +
  ...
  (function (t) {
    ...
    function o(t) {
      ...
      if ("image" == (n.clk = e).type)
        if (void 0 !== t.offsetX) (n.clk_x = t.offsetX), (n.clk_y = t.offsetY);
          ...
          (n.clk_x = t.pageX - e.offsetLeft), (n.clk_y = t.pageY - e.offsetTop);
      setTimeout(function () {
    ...
    (F.fn.attr2 = function () {
      ...
      (F.fn.ajaxSubmit = function (P) {
        ...
        if (
          (P.data && ((P.extraData = P.data), (n = F.param(P.data, o))),
          P.beforeSubmit && !1 === P.beforeSubmit(s, this, P))
        )
          return (
            O("ajaxSubmit: submit aborted via beforeSubmit callback"), this
          );
        if ((this.trigger("form-submit-validate", [s, this, P, i]), i.veto))
          return (
        ...
        var g,
          m = (h || p) && !f;
        !1 !== P.iframe && (P.iframe || m)
          ? P.closeKeepAlive
            ? F.get(P.closeKeepAlive, function () {
                g = b(s);
              })
            : (g = b(s))
          : (g =
                ...
                ? (function (t) {
                    ...
                    if (P.extraData) {
                      var o = (function (t) {
                        var e,
                          i,
                          o = F.param(t, P.traditional).split("&"),
                          n = o.length,
                          s = [];
                        for (e = 0; e < n; e++)
                          (o[e] = o[e].replace(/\+/g, " ")),
        ...
        function b(t) {
          ...
          if (
            (((d = F.extend(!0, {}, F.ajaxSettings, P)).context =
              d.context || d),
            (s = "jqFormIO" + new Date().getTime()),
            d.iframeTarget
              ? (n = (u = F(d.iframeTarget)).attr2("name"))
                ? (s = n)
                : u.attr2("name", s)
              : (u = F(
                  '<iframe name="' + s + '" src="' + d.iframeSrc + '" />'
                )).css({
                  position: "absolute",
                  top: "-1000px",
                  left: "-1000px",
            ...
            return d.global && F.active--, v.reject(), v;
          ...
          l && r && ((d.extraData = d.extraData || {}), (d.extraData[l] = r)),
          ...
          function C(t) {
            if (!f.aborted && !k) {
              if (
                ((w = x(p)) || (O("cannot access response document"), (t = y)),
                t === b && f)
              )
                  ...
                  if (a || d.textarea) {
                    ...
                    if (r)
                      (f.responseText = r.value),
                        (f.status =
                          Number(r.getAttribute("status")) || f.status),
                        (f.statusText =
                          r.getAttribute("statusText") || f.statusText);
                    else if (a) {
                  ...
                  f.status &&
                    (i =
                      (200 <= f.status && f.status < 300) || 304 === f.status
                        ...
                        : "error"),
                  "success" === i
                    ? (d.success && d.success.call(d.context, _, "success", f),
                      v.resolve(f.responseText, "success", f),
                      h && F.event.trigger("ajaxSuccess", [f, d]))
                    : i &&
          ...
          var T =
            ...
            $ = function (t, e, i) {
              ...
              return (
                ...
                "string" == typeof s &&
                  ("json" === e || (!e && 0 <= o.indexOf("json"))
                    ? (s = M(s))
                    : ("script" === e ||
                        (!e && 0 <= o.indexOf("javascript"))) &&
                      F.globalEval(s)),
                s
              );
            };
      ...
      (F.fn.ajaxForm = function (t) {
        if (
          (((t = t || {}).delegation = t.delegation && F.isFunction(F.fn.on)),
      ...
      (F.fn.formToArray = function (t, e) {
        ...
        if (
          (p && !/MSIE [678]/.test(navigator.userAgent) && (p = F(p).get()),
          u &&
            (o = F(':input[form="' + u + '"]').get()).length &&
            (p = (p || []).concat(o)),
          !p || !p.length)
        )
          return i;
        for (n = 0, c = p.length; n < c; n++)
          if ((a = (l = p[n]).name) && !l.disabled)
            if (t && h.clk && "image" == l.type)
              h.clk == l &&
                (i.push({ name: a, value: F(l).val(), type: l.type }),
                i.push(
                  { name: a + ".x", value: h.clk_x },
                  { name: a + ".y", value: h.clk_y }
                ));
            else if ((r = F.fieldValue(l, !0)) && r.constructor == Array)
              for (e && e.push(l), s = 0, d = r.length; s < d; s++)
                i.push({ name: a, value: r[s] });
            else if (y.fileapi && "file" == l.type) {
              e && e.push(l);
              var f = l.files;
              if (f.length)
                for (s = 0; s < f.length; s++)
                  i.push({ name: a, value: f[s], type: l.type });
              else i.push({ name: a, value: "", type: l.type });
            } else
              null != r &&
                (e && e.push(l),
                i.push({
      ...
      (F.fn.fieldValue = function (t) {
        for (var e = [], i = 0, o = this.length; i < o; i++) {
          ...
          null == s ||
            ...
            (s.constructor == Array ? F.merge(e, s) : e.push(s));
        }
        return e;
      }),
  ...
  (function (a, r) {
    ...
    (l._create = function () {
      ...
      (l._filter = function (t) {
        ...
        e = e || "*";
        for (
          var i = [], o = [], n = [], s = this._getFilterTest(e), a = 0;
          a < t.length;
          a++
        ) {
          var r = t[a];
...
var objectFitImages = (function () {
  ...
  function n(t, e) {
    ...
    for (var o = 0; o < t.length; o++)
      (t[o][l] = t[o][l] || { skipTest: e.skipTest }), r(t[o]);
    i &&
      ...
      e.watchMQ &&
        window.addEventListener(
          "resize",
          n.bind(null, t, { skipTest: e.skipTest })
        );
  }
  var l = "fregante:object-fit-images",
    ...
    m = !1;
  return (
    (n.supportsObjectFit = d),
    (n.supportsObjectPosition = h) ||
...
!(function (e) {
  ...
  function s(t, e, i) {
    ...
    "INPUT" !== a[0].nodeName &&
      console &&
      console.warn &&
      console.warn("Base element should be <input>!", a[0]),
    ((n = {
      skin: a.data("skin"),
      type: a.data("type"),
      min: a.data("min"),
    ...
    r !== h &&
      ...
      e && e.values && e.values.length
        ? ((o.from = r[0] && e.values.indexOf(r[0])),
          (o.to = r[1] && e.values.indexOf(r[1])))
        : ((o.from = r[0] && +r[0]), (o.to = r[1] && +r[1]))),
      l.extend(o, e),
      l.extend(o, n),
      (this.options = o),
      (this.update_check = {}),
  ...
  (s.prototype = {
            ...
            (i = s
              ...
              : ((o = this._prettify(this.result.from)),
                ...
                this.options.decorate_both
                  ...
                  : (t = this.decorate(
                      o + this.options.values_separator + n,
                      this.result.to
                    )),
    ...
    drawShadow: function () {
      ...
      "single" === n.type
        ? n.from_shadow && (a || r)
          ? ((t = this.convertToPercent(a ? n.from_min : n.min)),
    ...
    decorate: function (t, e) {
      ...
      return (
        ...
        (i += t),
        o.max_postfix &&
          ((o.values.length && t === o.p_values[o.max]) || e === o.max) &&
        ...
        for (
          ...
          (h += '<span class="irs-grid-pol" style="left: ' + c + '%"></span>'),
            ...
            (h +=
              ...
              c +
              '%">' +
              (s = a.values.length ? a.p_values[s] : this._prettify(s)) +
              "</span>");
        }
      ...
      g = {
        init: function (t) {
          ...
          C.liveSelector && (this.selector += "," + C.liveSelector),
            ...
            k(S)
              .unbind("." + T)
              .bind("scroll.mPS2id resize." + T, function () {
                if (m._isDisabled.call(null)) m._removeClasses.call(null);
                else {
                  var n = k("._mPS2id-t");
                  n.each(function (t) {
      ...
      m = {
        ...
        _isValid: function (t, e) {
          if (t) {
            ...
            return (
              "#" !== t &&
              -1 !== t.indexOf("#") &&
              ("" === i || decodeURIComponent(i) === decodeURIComponent(o))
            );
          }
        },
        _setup: function () {
            ...
            if (m._isValid.call(null, e, i)) {
              ...
              if (0 < n.length) {
                C.highlightByNextTarget &&
                  n !== l &&
                  (l ? l.data(T, { tn: n }) : n.data(T, { tn: "0" }), (l = n)),
        ...
        _findTarget: function (t) {
          ...
          return (
            ...
            ((r = [
              (i.offset().top - d[0]).toString(),
              (i.offset().left - d[1]).toString(),
            ])[0] = r[0] < 0 ? 0 : r[0]),
            (r[1] = r[1] < 0 ? 0 : r[1]),
            r
          );
        ...
        _setOffset: function () {
          var t, e, i, o;
          switch (
            ((d = d || (C.offset ? C.offset : 0)), h && (d = h), typeof d)
          ) {
            case "object":
            case "string":
              0 <
              (e = [
                (t = [d.y ? d.y : d, d.x ? d.x : d])[0] instanceof jQuery
                  ? t[0]
                  : k(t[0]),
                t[1] instanceof jQuery ? t[1] : k(t[1]),
              ])[0].length
                ? ((i = e[0].height()),
              ...
              break;
            case "function":
              (t = d.call(null)) instanceof Array
                ? ((i = t[0]), (o = t[1]))
                : (i = o = t);
              break;
            default:
        ...
        _setClasses: function (t, e, i) {
          var o = C.clickedClass,
            ...
            s = C.highlightClass;
          t && o && "" !== o
            ? (k("." + o).removeClass(o), a.addClass(o))
            : e &&
              n &&
              "" !== n &&
              i &&
              ...
              (m._currentTarget.call(null, e)
                ? (e.addClass(n), i.addClass(s))
                : (!C.keepHighlightUntilNext || 1 < k("." + s).length) &&
                  (e.removeClass(n), i.removeClass(s)));
        },
          ...
          k("._mPS2id-t").removeClass(n + " " + s),
            ...
            C.forceSingleHighlight
              ? C.keepHighlightUntilNext && 1 < i.length
                ? (i.slice(0, 1).removeClass(t), o.slice(0, 1).removeClass(e))
                : (i.slice(1).removeClass(t), o.slice(1).removeClass(e))
              : (i.slice(0, 1).addClass(n).end().slice(-1).addClass(s),
                o.slice(0, 1).addClass(a).end().slice(-1).addClass(r));
        },
        _removeClasses: function (t) {
          k("." + C.clickedClass).removeClass(C.clickedClass),
            k("." + C.targetClass).removeClass(
              C.targetClass +
                " " +
                C.targetClass +
                "-first " +
            ...
            k("." + C.highlightClass).removeClass(
              C.highlightClass +
                " " +
                C.highlightClass +
                "-first " +
            ...
            t &&
              (k("._mPS2id-t").removeClass("_mPS2id-t"),
        ...
        _currentTarget: function (t) {
          ...
          if (C.highlightByNextTarget) {
            ...
            if (_) {
              ...
              "vertical" === C.layout
                ? (x = [o.top <= d / 2, w.top > d / 2, 1, 1])
                : "horizontal" === C.layout &&
                  (x = [1, 1, o.left <= h / 2, w.left > h / 2]);
            }
          }
            ...
            case "auto":
              if (o != r[0] || n != r[1])
                if (
                    ...
                    .animate(
                      { pageYOffset: r[0], pageXOffset: r[1] },
                      {
                        ...
                        step: function (t, e) {
                          "pageXOffset" == e.prop
                            ? (s = t)
                            : "pageYOffset" == e.prop && S.scrollTo(s, t);
                        },
                      }
                    )
                    .promise()
                  ...
                  t.stop()
                    .animate({ scrollTop: r[0], scrollLeft: r[1] }, e, i)
                    .promise()
                    .then(function () {
                      m._callbacks.call(null, "onComplete");
                    });
        ...
        _autoScrollSpeed: function () {
          var t = k(S).scrollTop(),
            ...
            n = [
              ...
              u + (u * Math.floor((Math.abs(r[1] - e) / o) * 100)) / 100,
            ];
        ...
        _live: function () {
          t = setTimeout(function () {
            C.live
              ? k(m._highlightSelector()).length !== f && m._setup.call(null)
              : t && clearTimeout(t),
              m._live.call(null);
          }, 1e3);
        },
        _easing: function () {
          ...
          (k.easing.easeInQuad =
            ...
            (k.easing.easeOutQuad =
              k.easing.easeOutQuad ||
              function (t) {
                return 1 - (1 - t) * (1 - t);
              }),
            (k.easing.easeInOutQuad =
              k.easing.easeInOutQuad ||
              function (t) {
                return t < 0.5 ? 2 * t * t : 1 - Math.pow(-2 * t + 2, 2) / 2;
              }),
            (k.easing.easeInCubic =
              k.easing.easeInCubic ||
              function (t) {
                return t * t * t;
              }),
            ...
            (k.easing.easeInQuint =
              k.easing.easeInQuint ||
              function (t) {
                return t * t * t * t * t;
              }),
            (k.easing.easeOutQuint =
              k.easing.easeOutQuint ||
              function (t) {
                return 1 - Math.pow(1 - t, 5);
              }),
            (k.easing.easeInOutQuint =
              k.easing.easeInOutQuint ||
              function (t) {
                return t < 0.5
                  ? 16 * t * t * t * t * t
            ...
            (k.easing.easeOutExpo =
              k.easing.easeOutExpo ||
              function (t) {
                return 1 === t ? 1 : 1 - Math.pow(2, -10 * t);
              }),
            (k.easing.easeInOutExpo =
              k.easing.easeInOutExpo ||
              function (t) {
                return 0 === t
                  ? 0
            ...
            (k.easing.easeOutSine =
              k.easing.easeOutSine ||
              function (t) {
                return Math.sin((t * Math.PI) / 2);
              }),
            (k.easing.easeInOutSine =
              k.easing.easeInOutSine ||
              function (t) {
            ...
            (k.easing.easeOutCirc =
              k.easing.easeOutCirc ||
              function (t) {
                return Math.sqrt(1 - Math.pow(t - 1, 2));
              }),
            (k.easing.easeInOutCirc =
              k.easing.easeInOutCirc ||
              function (t) {
                return t < 0.5
    ...
    m._easing.call(),
      (k.fn[e] = function (t) {
        return g[t]
          ...
          : "object" != typeof t && t
          ? void k.error("Method " + t + " does not exist")
            ...
            !r.options.verticalSwiping && !r.swiping && 4 < a
              ...
              : (!0 === r.options.verticalSwiping &&
                ...
                !1 === r.options.vertical
                  ? (r.swipeLeft = e + o * n)
                  : (r.swipeLeft =
                      e + o * (r.$list.height() / r.listWidth) * n),
  ...
  (function (d, n) {
    ...
    (o.prototype.init = function () {
      ...
      (o.prototype._closeTab = function (t, e) {
        ...
        void 0 !== e &&
          ((i =
            (n && o.getState() === o.options.animationQueue) ||
            (!n && o.options.animationQueue)),
          (e.active = !1),
          e.tab
        ...
        return void 0 === t || "object" == typeof t
          ? this.each(function () {
              d.data(this, "responsivetabs") ||
                d.data(this, "responsivetabs", new o(this, t));
            })
          : "string" == typeof t && "_" !== t[0] && "init" !== t
          ? ((e = d.data(this[0], "responsivetabs")),
    ...
    d.extend(d.fn, {
                  ...
                  function t() {
                    ...
                    return (
                      ...
                      !(o.settings.submitHandler && !o.settings.debug) ||
                        ((e = o.settings.submitHandler.call(
                          o,
                          o.currentForm,
                          i
                        )),
      ...
      rules: function (t, e) {
        ...
        if (
          ...
          if (t)
            switch (
              ((o = (i = d.data(l.form, "validator").settings).rules),
          ...
          return (
            (s = d.validator.normalizeRules(
              ...
              ((a = s.required),
              delete s.required,
              (s = d.extend({ required: a }, s))),
            s.remote &&
              ((a = s.remote),
              delete s.remote,
              (s = d.extend(s, { remote: a }))),
            s
          );
        }
      },
        ...
        methods: {
          ...
          remote: function (s, a, t, r) {
            ...
            return (
              ...
              (i = d.param(d.extend({ data: s }, t.data))),
              c.old === i
                ? c.valid
                : ((c.old = i),
        ...
        return (
          ...
          (t.prototype.checkEmpty = function () {
            if (
              ...
              return this.$element.unbind([p, f].join(" ")), delete h[this.id];
          }),
          (a = t),
              ...
              return (
                ...
                this.each(function () {
                  ...
                  return (
                    (t = l(this)),
                    (i =
                      null != (o = n.context) ? o : l.fn[v].defaults.context),
            ...
            _invoke: function (t, i) {
              return (
                t.each(function () {
                  var t;
                  return (
                    (t = r.getWaypointsByElement(this)),
